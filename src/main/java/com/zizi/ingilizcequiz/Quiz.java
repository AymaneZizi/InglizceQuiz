...
public class Quiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        quiz=getIntent().getIntExtra(MainActivity.QUIZ_KEY,MainActivity.numbers);
        ...
        switch (quiz){
            case MainActivity.numbers:
                String[] dizi=getResources().getStringArray(R.array.number);
                for (String s:dizi){
                    genelListe.add(s);
                }
                break;
            case MainActivity.colos:
                soru_tv.setTextSize(40);
                String[] dizi2=getResources().getStringArray(R.array.color);
                for (String s:dizi2){
                    genelListe.add(s);
                }
                break;
            case MainActivity.animals:
                soru_tv.setTextSize(40);
                String[] dizi3=getResources().getStringArray(R.array.animal);
                for (String s:dizi3){
                    genelListe.add(s);
                }
                break;
